    ...
    <TR>
      ...
      <TD style="WIDTH:100%" height="100%"> <table border=0 cellPadding=0 cellSpacing=0 height="100%" width="100%">
          <tr height=30 bgcolor="#6db8e0">
			...
			?>			</td>
            <td width="25%" bgcolor="#6db8e0"><div align="center"><strong><font color="#0000FF">歡迎使用智安云備份 [<a href="http://www.phome.net/" target="_blank"><font color="#0000FF">官方網站</font></a>]</font></strong></div></td>
