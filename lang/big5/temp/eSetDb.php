  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" class="tableborder" id="setebma" style="display:none">
	...
	<tr>
	  ...
	  <td height="25" bgcolor="#FFFFFF"><input type="radio" name="ebmacklogin" value="0"<?=$ebak_ebma_cklogin==0?' checked':''?>>開啟
          <input type="radio" name="ebmacklogin" value="1"<?=$ebak_ebma_cklogin==1?' checked':''?>>關閉 <font color="#666666">(開啟後，進入phpmyadmin需要再次登錄數據庫，即：智安云備份驗證+PMA本身雙重驗證)</font>
	  </td>
    </tr>
  </table>
	...
	?>
    <tr>
      <td height="30" colspan="2" bgcolor="#FFFFFF"><font color="#FF0000">首次安裝智安云備份，請修改<strong>管理員設置</strong>裡的默認<strong>管理密碼</strong>和<strong>驗證隨機碼</strong>。修改後需要重新登錄後台。(至於默認<strong>用戶名</strong>不強制，但官方推薦也修改)</font></td>
    </tr>
	<?php
	}
	?>
