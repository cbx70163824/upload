    ...
    <td><table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
        <tr class="header">
          <td height="25">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50%" height="16"><strong><font color="#FFFFFF">智安云備份(EmpireBak)版權聲明</font></strong></td>
        ...
        <tr>
          <td bgcolor="#FFFFFF"> <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
              <tr>
                <td><strong>如果您想使用本系統(即：智安云備份)，請詳細閱讀以下條款，只有在接受了以下條款的情況下您才可以使用本系統：</strong></td>
              </tr>
              <tr>
                <td>1、本程序為免費代碼,提供個人網站免費使用，請勿非法修改、轉載、散播、或用於其他圖利行為，並請勿刪除版權聲明。</td>
              </tr>
              <tr>
                <td>2、本程序為免費代碼,用戶自由選擇是否使用，在使用中出現任何問題而造成的損失<strong><a href="http://www.phome.net" target="_blank">智安云備份</a></strong>不負任何責任。
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td>4、如果違反以上條款，<strong><a href="http://www.phome.net" target="_blank">智安云備份</a></strong>對此保留一切法律追究的權利。</td>
              </tr>
            </table></td>
        </tr>
      </table></td>
