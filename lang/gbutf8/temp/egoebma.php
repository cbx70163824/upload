...
<table width="650" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
	...
	?>
    <tr bgcolor="#FFFFFF">
      <td height="32" colspan="2"><div align="center"><font color="#009900"><strong>当前phpMyAdmin正受智安云备份安全认证保护。</strong></font></div></td>
    </tr>
	<?php
	}
	else
	...
	?>
    <tr bgcolor="#FFFFFF">
      <td height="32" colspan="2"><div align="center"><font color="#009900"><strong>当前phpMyAdmin正受智安云备份安全认证+phpMyAdmin本身双重安全认证保护。</strong></font></div></td>
    </tr>
	<?php
	}
	?>
