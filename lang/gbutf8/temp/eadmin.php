...
<title>欢迎使用智安云备份系统</title>
<base onmouseover="window.status='智安云备份';return true">
...
<TABLE border=0 cellPadding=0 cellSpacing=0 height="100%" width="100%">
  <TBODY>
    <TR>
      ...
      <TD rowspan="2" bgColor="#6db8e0" height="100%"> <TABLE border=0 cellPadding=0 cellSpacing=0 height="100%">
          <TBODY>
            <tr>
      ...
      <TD style="WIDTH:100%" height="100%"> <table border=0 cellPadding=0 cellSpacing=0 height="100%" width="100%">
          <tr height=30 bgcolor="#6db8e0">
            <td width="40%" bgcolor="#6db8e0">
			<?php
			...
			?>			</td>
            <td width="25%" bgcolor="#6db8e0"><div align="center"><strong><font color="#0066CC">欢迎使用智安云备份系统 [<a href="http://www.zhiannet.com/" target="_blank"><font color="#0068BF">官方网站</font></a>]</font></strong></div></td>
            <td width="35%" bgcolor="#6db8e0">
              <div align="right">
                语言：
