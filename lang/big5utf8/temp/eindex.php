...
<table width="100%" border="0" cellspacing="8" cellpadding="3">
  <tr>
    ...
    <tr>
      <td><div align="center"><strong><font size="5">歡迎使用智安云備份系統</font></strong></div></td>
    </tr>
    <tr>
    ...
    <tr>
      <td><table width="420" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
        <form name="form1" method="post" action="phome.php">
          ...
          <tr class="header">
            <td height="25" colspan="2"><div align="center">后台登錄</div></td>
          </tr>
          <tr bgcolor="#FFFFFF">
          ...
          <tr bgcolor="#FFFFFF">
            ...
            <td height="25"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td id="eshowkeyarea"><a href="#CloudBak" onclick="ebakshowkey();">點擊顯示驗證碼</a></td>
                </tr>
              </table></td>
          </tr>
          <?php
