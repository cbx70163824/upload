...
<table width="650" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
	...
	?>
    <tr bgcolor="#FFFFFF">
      <td height="32" colspan="2"><div align="center"><font color="#009900"><strong>當前phpMyAdmin正受智安云備份安全認證保護。</strong></font></div></td>
    </tr>
	<?php
	}
	else
	...
	?>
    <tr bgcolor="#FFFFFF">
      <td height="32" colspan="2"><div align="center"><font color="#009900"><strong>當前phpMyAdmin正受智安云備份安全認證+phpMyAdmin本身雙重安全認證保護。</strong></font></div></td>
    </tr>
	<?php
	}
	?>
