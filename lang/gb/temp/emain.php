    ...
    <td><table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
        <tr class="header">
          <td height="25">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50%" height="16"><strong><font color="#FFFFFF">智安云备份(EmpireBak)版权声明</font></strong></td>
        ...
        <tr>
          <td bgcolor="#FFFFFF"> <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
              <tr>
                <td><strong>如果您想使用本系统(即：智安云备份)，请详细阅读以下条款，只有在接受了以下条款的情况下您才可以使用本系统：</strong></td>
              </tr>
              <tr>
                <td>1、本程序为免费代码,提供个人网站免费使用，请勿非法修改、转载、散播、或用于其他图利行为，并请勿删除版权声明。</td>
              </tr>
              <tr>
                <td>2、本程序为免费代码,用户自由选择是否使用，在使用中出现任何问题而造成的损失<strong><a href="http://www.phome.net" target="_blank">智安云备份</a></strong>不负任何责任。
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td>4、如果违反以上条款，<strong><a href="http://www.phome.net" target="_blank">智安云备份</a></strong>对此保留一切法律追究的权利。</td>
              </tr>
            </table></td>
        </tr>
      </table></td>
