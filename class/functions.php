...
function printerror($error = "", $gotourl = "", $ecms = 0)
{
    ...
    if ($ecms == 0) {
        if($error=='LoginSuccess' || $error=='ExitSuccess'){
            @include EBAK_PATH . LoadLang("m.php");
            echo "<script>" . $gotourl_js . "</script>";
        }else{
            @include EBAK_PATH . LoadLang("m.php");
...
function Ebak_EchoBakSt($tbname, $tbnum, $tb, $rnum, $r)
{
    ...
    <table width="90%" border="0" align="center" cellpadding="3" cellspacing="1">
        <tr>
            <td height="25">Table Name&nbsp;:&nbsp;<b><?= $tbname ?></b></td>
        </tr>
        <tr>
            <td height="25">Table&nbsp;:&nbsp;<b><?= $table ?></b></td>
        </tr>
        <tr>
            <td height="25">Record&nbsp;:&nbsp;<b><?= $record ?></b></td>
        </tr>
    </table><br><br>
    <?
}
...
function Ebak_EchoReDataSt($tbname, $tbnum, $tb, $pnum, $p)
{
    ...
    <table width="90%" border="0" align="center" cellpadding="3" cellspacing="1">
        ...
        <tr>
            <td height="25">File&nbsp;:&nbsp;<b><?= $record ?></b></td>
        </tr>
    </table><br><br>
    <?
}
